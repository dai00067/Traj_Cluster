...
def angular_distance(line_a, line_b):
    ...
    #print(sine_coefficient)
    #print(longer_line.length -shorter_line.length)
    #print(shorter_line.cose_of_angle_with(longer_line))
    #print(abs(sine_coefficient * shorter_line.length))
    return(abs(sine_coefficient * shorter_line.length))
    #if shorter_line.cose_of_angle_with(longer_line)>0:
    #    return abs(sine_coefficient * shorter_line.length)
    #    print(abs(sine_coefficient * shorter_line.length))
    #elif shorter_line.cose_of_angle_with(longer_line)<=0:
    #    return abs(shorter_line.length)
    #    print('<=0')
    #else:
    #    return 0
    #print('1111')
