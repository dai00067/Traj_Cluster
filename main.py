...
def main(input_file, 
    ...
    #pass trajs to the real run_traclus function
...
def parse_input_and_run_traclus(
         input_file,
         partitioned_trajectories_output_file_name=None,
         clusters_output_file_name=None):
    parsed_input = None
...
def get_correct_path_to_file(file_name):
    ...
    #main('C:/Users/zoed0/Desktop/UBiAi/fengkong/traclus_impl-master/traclus_impl/integ_tests/sampleList.txt',\
    #     'C:/Users/zoed0/Desktop/UBiAi/fengkong/data/copy_06/dict1_traclus_output.txt')
